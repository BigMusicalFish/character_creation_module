...
def attack(char_name: str, char_class: str) -> str:
    """Calculate and return the attack damage parameter for each class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate and return the blocked damage parameter for each class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate and return the parameter of the special ability."""
    if char_class == 'warrior':
